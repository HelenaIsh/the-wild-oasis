...
function prepareData(startData: DurationDataType[], stays: Booking[]) {
  // A bit ugly code, but sometimes this is what it takes when working with real data 😅

  function incArrayValue(arr: DurationDataType[], field: string) {
    return arr.map((obj: DurationDataType) =>
      obj.duration === field ? { ...obj, value: obj.value + 1 } : obj
    );
  }

  return stays
    .reduce((arr: DurationDataType[], cur) => {
